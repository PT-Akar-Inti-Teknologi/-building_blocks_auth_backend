...
export const generateMessageCreateTicket = async (
  ...
  const ticketBanner = 'https://efood.co.id/images/efood-banner.png';
  const message = `
  <p style="${STYLE_HEADER}"> Dear, ${name || 'User'}! </p>
  <p style="${CONTENT16}"> Terima kasih telah menghubungi Pusat Bantuan eFOOD. </p>
  ...
  <p style="${CONTENT16}"> eFOOD Customer Service </p>
